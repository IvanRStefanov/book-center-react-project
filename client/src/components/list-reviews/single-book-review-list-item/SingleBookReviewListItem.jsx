...
export default function SingleBookReviewListItem({
    ...
    async function deleteComment() {
        ...
        try {
            ...
            const oldUserData = loggedInUser;
            console.log('old user data', oldUserData);

            const newUserRates = oldUserData.ratedBooks.filter(bookId => bookId !== review.bookId);
            const newUserData = {...oldUserData, "ratedBooks": newUserRates}
